...
def main(chunk_file):    
    ...
    for index, row in docs_df.iterrows():
        if row['complete'] == 0:
            ...
            docs_master.loc[docs_master['title'] == row['title'], 'complete'] = 1        
            ...
            section_new_path = f"{inference_dir}/sections_{year}_pt{part}.csv"
            speech_new_path = f"{inference_dir}/speeches_{year}_pt{part}.csv"
            speakers_new_path = f"{inference_dir}/speakers_{year}_pt{part}.csv"
