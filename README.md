...
Key processed files are in `datastore/inference`:
...
To illustrate the contents of the files,  [this script](./source/analysis/plots.py) makes basic data plots for the year 1902.
